...
class RepresentationAnalyzer:
    ...
    def find_optimal_clusters(self, features, max_clusters=20): 
        ...
        for k in k_range:
            print(f"\rTesting k={k}/{max_clusters}", end="")
        ...
        # Return the average of both methods, rounded to nearest integer
...
def main():
    ...
    try:
        ...
        clusters, n_clusters = analyzer.cluster_features(features)  # Let it find optimal clusters
